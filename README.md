...
[![Built with xrpl-mpp-sdk](https://img.shields.io/badge/built%20with-xrpl--mpp--sdk-2b6cb0)](https://github.com/ripple/xrpl-mpp-sdk)
...
> real value. Forking and adapting it is encouraged; running it unmodified against live
> funds is not.
...
This project is an independent consumer of [`xrpl-mpp-sdk`](https://github.com/ripple/xrpl-mpp-sdk)
...
scripts/     # check-testnet, check-channel, check-policy, demo
```
...
```bash
pnpm install               # pulls xrpl-mpp-sdk from npm
...
multi-agent competition; cumulative/rolling spend limits; a separate signer service.
